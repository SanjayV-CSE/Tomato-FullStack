...
const Header = () => {
  return (
    <div className='py-6'>
      <div className="h-[600px] bg-contain bg-no-repeat bg-[url('C:\Users\sanju\Tomato-FullStack\food-del\public\header_img.png')] p-5 text-white space-y-5 flex flex-col justify-center">
